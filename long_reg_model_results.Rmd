...
centiles_filename <- "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/CSV/Centile_CSVs/regional_longmodel_volume_centiles.csv"
```
...
```{r}
neo_comp_reg_table_full_sig$label <- name_mapping$region_name[match(sub(".t2_centiles", "", rownames(neo_comp_reg_table_full_sig)), name_mapping$abbreviation)]
