...
```{r}
sOne_refit_phenotypes <- sOne_wp_table$label
...
sOne_wp_refit_table <- data.frame(matrix(NA, nrow = dim(sOne_best)[1], ncol = 5))
names(sOne_wp_table) <- c("n", "n_outer", "pcnt", "phenotype", "label", "model_index")
