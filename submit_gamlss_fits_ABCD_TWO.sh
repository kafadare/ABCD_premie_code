#!/bin/bash
#SBATCH --job-name=ABCD_t2_all_Two
#SBATCH --output=/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/gamlss_fits_t2_all_TWO/out_messages/%x_%A_%a_output.txt
